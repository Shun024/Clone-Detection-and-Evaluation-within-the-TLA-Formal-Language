...
colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728']  # Change/add colors as needed

# Plotting the bar graph 
fig, ax = plt.subplots(figsize=(12, 6))
clone_types = ['Type-1 Clones', 'Type-2 Clones', 'Type-3 Clones', 'Type-4 Clones']
...
ax.set_title('Clone Types of Each File (excluding Type 5)', fontsize=14)
...
plt.tight_layout()
plt.savefig('indi_clone_types_no_ty5.png')
