...
def clone_type_pie(parsed_stats, tokenized_stats, png_image):
	...
	total= type1_file1 + type1_file2 + type2_file2 + type3_file2 + type4_file2
	...
	labels = ['parsed-type1', 'tokenized-type1', 'tokenized-type2', 'tokenized-type3', 'tokenized-type4']
	...
	explode = (0.1, 0, 0, 0, 0)  # explode the 1st slice (Type-1 Clones from File1)
	...
	plt.title('Distribution of Clones (without Type-5 clones)')
	plt.tight_layout()
...
clone_type_pie('small_raw_statistics.txt', 'small_files_statistics.txt', 'small_clone_type_pie_without_type5.png')
clone_type_pie('large_raw_statistics.txt', 'large_files_statistics.txt', 'large_clone_type_pie_without_type5.png')
clone_type_pie('raw_statistics.txt', 'files_statistics.txt', 'whole_clone_type_pie_without_type5.png')
